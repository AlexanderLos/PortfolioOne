      ...
      <main id="main">
        <Section flush>
          <article className="mx-auto max-w-2xl">
            <Link
              href="/blog"
              className="font-sans text-[0.6875rem] uppercase tracking-[0.18em] text-subtle transition-colors hover:text-fg"
            >
            ...
            <h1 className="mt-6 font-display text-[clamp(2rem,5vw,3.25rem)] font-semibold leading-[1.1] tracking-[-0.02em] text-fg">
              {post.title}
            </h1>
            <p className="mt-5 text-[1.125rem] leading-[1.7] text-muted">
              {post.summary}
            </p>
            <p className="mt-6 flex flex-wrap gap-2 border-b border-border pb-8 font-sans text-[0.625rem] uppercase tracking-[0.18em] text-subtle">
              {post.tags.map((tag) => (
