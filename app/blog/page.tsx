  ...
  return (
    <>
      ...
      <main id="main">
        <Section flush>
          <Eyebrow label="Blog" />
          <h1 className="mt-6 max-w-3xl font-display text-[clamp(2.25rem,6vw,4rem)] font-semibold leading-[1.05] tracking-[-0.02em] text-fg">
            Notes.
          </h1>
              ...
              <li key={post.slug} className="group border-b border-border">
                ...
                >
                  ...
                  <div className="mt-3 md:mt-0">
                    ...
                    <p className="mt-3.5 flex flex-wrap gap-2 font-sans text-[0.625rem] uppercase tracking-[0.18em] text-subtle">
                      {post.tags.map((tag) => (
          ...
          {posts.length === 0 && (
            <p className="mt-16 border-t border-border pt-8 font-sans text-[0.6875rem] uppercase tracking-[0.18em] text-subtle">
