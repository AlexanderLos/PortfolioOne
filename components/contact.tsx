    ...
    <Section id="contact">
      <div className="reveal flex flex-col items-center py-6 text-center md:py-14">
        ...
        <a
          ...
          className="mt-7 break-all font-display text-[clamp(1.5rem,4.5vw,3rem)] font-semibold tracking-[-0.015em] text-fg underline decoration-accent decoration-2 underline-offset-8 transition-colors hover:decoration-accent-bright sm:break-normal"
        >
          {profile.email}
        </a>
